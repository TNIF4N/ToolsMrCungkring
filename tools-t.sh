...
echo "Tools    : Tools Mr.Cungkring  $white                         " |lolcat
echo "Creadby  : Tn.IF4N H                                      " |lolcat
echo "Contact  : 0895397317328   $white                             " |lolcat
echo "_____________________________________________________________"



echo "\033[34;1m[01] LiteDDos untuk website" | lolcat
...
echo "\033[35;1m Silahkan pilih yang mau anda install" | lolcat

read -p "#Dipilih ~>#" pilihan
